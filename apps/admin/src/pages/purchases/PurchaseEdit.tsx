        ...
        <Stack spacing={8} direction="row">
          <Box p={5} shadow="md" borderWidth="1px" bg="white">
            ...
            <Text mt={4}>
              ...
              <br />
              État : <b>{ucFirst(getStatus(data.purchase.status).value)}</b>
              <br />
            </Text>
          </Box>
          <Box p={5} shadow="md" borderWidth="1px" bg="white" flex="1">
            ...
            {data?.purchase.addresses.length === 1 ? (
              <AddressItem
                address={
                  data.purchase.addresses.find((a) => a.type === 'SINGLE') ?? ({} as Address)
                }
              />
            ) : (
              <>
          ...
          <Box p={5} shadow="md" borderWidth="1px" bg="white" flex="1" px={7} mt={gap}>
            ...
            <Text>
              ...
              {data?.purchase.purchaseItems
                ...
                .reduce((a, b) => a + b) +
                data?.purchase.insuranceCost +
                data?.purchase.weightCost}
            </Text>
          </Box>
        </Stack>
      </Box>
  ...
  return (
    <Box mt="5">
      {address.type === 'SINGLE' ? (
        ...
        <Heading fontSize="1xl">Adresse de {getAddress(address.type).value}</Heading>
      )}
      <Text mt={4}>
        {address.fullname}
        <br />
